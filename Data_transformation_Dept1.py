#TRANSFORMATION- Testing whether address column in Target(MYSQL) Data base is concatenation of DNAME &LOC
...
def test_dataExtractionFromOracleToLoadIntoMYSQL(connect_to_oracle_SRC, connect_to_mysql_TGT):
    query_orcl_src = "SELECT DEPTNO ,DNAME,DNAME ||','|| LOC AS ADDRESS FROM DEPT1"
    ...
    if df_orcl_src.empty:
        ...
        query_mysql_tgt = "Select deptno,dname,address from dept1"
